...
export type CreateAdMutation = { __typename?: 'Mutation', createAd: { __typename?: 'Ad', description: string, location: string, price: number, selectedEquipmentValues?: Array<string> | null, title: string } };
