...
export type Query = {
  ...
  getAds: Array<Ad>;
  getAdsByBookings: Array<Booking>;
  getBokings: Array<Booking>;
  getBooking: Booking;
...
export type GetBookingsByUserQueryVariables = Exact<{
  userId: Scalars["String"]["input"];
}>;

export type GetBookingsByUserQuery = {
  __typename?: "Query";
  getBookingsByUser: Array<{
    __typename?: "Booking";
    checkinDate: any;
    checkoutDate: any;
    datePayment: any;
...
export type FilterByHouseTypeQuery = {
  __typename?: "Query";
  filterByHouseType: Array<{ __typename?: "Ad"; id: string }>;
};
...
export const GetBookingsByUserDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetBookingsByUser" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetBookingsByUserQueryVariables
>;
