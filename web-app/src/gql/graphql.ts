...
export type Mutation = {
  ...
  createUser: User;
  handlePaymentIntentSucceededWebhook: PaymentStatusEnum;
  signIn: User;
...
export type HandlePaymentIntentSucceededWebhookMutationVariables = Exact<{
  bookingId: Scalars['String']['input'];
}>;


export type HandlePaymentIntentSucceededWebhookMutation = { __typename?: 'Mutation', handlePaymentIntentSucceededWebhook: PaymentStatusEnum };
...
export const HandlePaymentIntentSucceededWebhookDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"HandlePaymentIntentSucceededWebhook"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"handlePaymentIntentSucceededWebhook"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"bookingId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"bookingId"}}}]}]}}]} as unknown as DocumentNode<HandlePaymentIntentSucceededWebhookMutation, HandlePaymentIntentSucceededWebhookMutationVariables>;
