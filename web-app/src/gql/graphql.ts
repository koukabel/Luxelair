...
export type GetEquipementsQuery = {
  __typename?: "Query";
  getEquipmentTypes: Array<string>;
};
...
export type FilerByPriceQuery = {
  __typename?: "Query";
  filerByPrice: Array<{ __typename?: "Ad"; id: string }>;
};
...
export type GetMyProfilUpdateQuery = {
  __typename?: "Query";
  myProfile: {
    __typename?: "User";
    email: string;
...
export type QueryQuery = {
  __typename?: "Query";
  getSucceededBookings: Array<string>;
};

export type GetMyProfilQueryVariables = Exact<{ [key: string]: never }>;

export type GetMyProfilQuery = {
  __typename?: "Query";
  myProfile: {
    __typename?: "User";
    email: string;
...
export type GetBookingsByHostQuery = {
  __typename?: "Query";
  getBookingsByHost: Array<{
    __typename?: "Booking";
    checkinDate: any;
    checkoutDate: any;
    datePayment: any;
    ...
    totalPrice: number;
    ad: { __typename?: "Ad"; id: string; title: string };
...
export type GetBookingsByAdsQuery = {
  __typename?: "Query";
  getBookingsByAds: Array<{
    __typename?: "Booking";
    checkinDate: any;
    checkoutDate: any;
    id: string;
...
export type DeleteAdMutation = {
  __typename?: "Mutation";
  deleteAd: { __typename?: "Ad"; id: string; title: string };
};
...
export type AdCreationMutation = {
  __typename?: "Mutation";
...
export type FilterByPriceQuery = {
  __typename?: "Query";
  filerByPrice: Array<{
    __typename?: "Ad";
    id: string;
...
export type FilterByHouseTypeQuery = {
  __typename?: "Query";
  filterByHouseType: Array<{
    __typename?: "Ad";
    id: string;
...
export const GetHousingTypesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetHousingTypes" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "getHousingTypes" } },
        ],
      },
    },
  ],
...
>;
export const GetEquipementsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEquipements" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "getEquipmentTypes" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<GetEquipementsQuery, GetEquipementsQueryVariables>;
...
export const FilerByPriceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<FilerByPriceQuery, FilerByPriceQueryVariables>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "filterByHouseType" },
            arguments: [
              {
                kind: "Argument",
...
} as unknown as DocumentNode<FilterTypeQuery, FilterTypeQueryVariables>;
...
export const SearchAdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "SearchAd" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<SearchAdQuery, SearchAdQueryVariables>;
...
>;
export const GetMyProfilUpdateDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMyProfilUpdate" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetMyProfilUpdateQueryVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "getSucceededBookings" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "userId" },
...
export const GetMyProfilDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetMyProfil" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<GetMyProfilQuery, GetMyProfilQueryVariables>;
export const GetAdsByUserDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAdsByUser" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "getAdsByUserId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "title" } },
                { kind: "Field", name: { kind: "Name", value: "housingType" } },
                { kind: "Field", name: { kind: "Name", value: "equipements" } },
                { kind: "Field", name: { kind: "Name", value: "description" } },
              ],
            },
          },
...
} as unknown as DocumentNode<GetAdsByUserQuery, GetAdsByUserQueryVariables>;
export const GetBookingsByHostDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetBookingsByHost" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "datePayment" } },
                { kind: "Field", name: { kind: "Name", value: "id" } },
                { kind: "Field", name: { kind: "Name", value: "status" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "statusPayment" },
                },
  ...
  GetBookingsByHostQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetBookingsByAds" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "getBookingsByAdsId" },
          },
          type: {
            kind: "NonNullType",
            type: {
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "getBookingId" },
          },
          type: {
            kind: "NonNullType",
            type: {
...
} as unknown as DocumentNode<GetBookingQuery, GetBookingQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "updateAdId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "HousingTypeEnum" },
          },
        },
        {
          kind: "VariableDefinition",
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "deleteAdId" },
          },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
...
export const AdCreationDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "adCreation" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<AdCreationMutation, AdCreationMutationVariables>;
export const FilterByPriceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<FilterByPriceQuery, FilterByPriceQueryVariables>;
export const FilterByHouseTypeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FilterByHouseTypeQuery,
  FilterByHouseTypeQueryVariables
>;
